...
import com.example.dharmshalaowner.dhaaramshalaown.Adapters.ChildPlaceOffersAdapter;
import com.example.dharmshalaowner.dhaaramshalaown.Adapters.PlaceDescriptionAdapter;
        ...
        help.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(count == 1) {
                    ...
                    dialog.setMessage("Upload the respective room images.");
                    dialog.setNegativeButton("Ok",
                            new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialogInterface, int i) {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(count == 0) {
                  ...
                  /*  if(Upload_image.getPlaceimagelist().size() > 2)*/
                    {
                        inflateFragment(new PlaceRoomImage());
                    }
                   /* else {
                        Toast.makeText(getContext(), "You have to provide your hotel images here..", Toast.LENGTH_SHORT).show();
                    }*/
                }
                else if(count == 10) {
                    /*if(PlaceRoomImage.getPlaceimagelistroom().size() > 1)*/
                    {
                        placeOverview = new PlaceOverview();
                        inflateFragment(placeOverview);
                    }
                    /*else {
                        Toast.makeText(getContext(), "You have to provide your hotel room images here..", Toast.LENGTH_SHORT).show();
                    }*/
                    next.setText("Save");
                }
              ...
              //       GOES INTO LANDING PAGE
                       inflateFragment(new about_hotel());

               //       TO REMOVE TOLBAAR BUTTONS
